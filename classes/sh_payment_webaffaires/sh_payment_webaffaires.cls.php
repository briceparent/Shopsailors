 ...
 */
class sh_payment_webaffaires extends sh_payment_atos {

    const CLASS_VERSION = '1.1.11.12.05';

    protected $parmcom_bankExtension = 'webaffaires';
    protected $lastErrorId = 0;
    protected $ready = false;
    const DEV_NAME = 'Crédit du Nord / Shopsailors';
    const DEV_WEBSITE = 'http://wiki.websailors.fr';
    const DEV_EMAIL = 'brice.parent@websailors.fr';
    protected $bank_code = 30076;
    protected $bankName = 'Webaffaires - Crédit du Nord';

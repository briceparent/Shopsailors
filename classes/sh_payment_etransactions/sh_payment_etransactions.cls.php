 ...
 */
class sh_payment_etransactions extends sh_payment_atos {

    const CLASS_VERSION = '1.1.11.12.05';

    protected $parmcom_bankExtension = 'e-transactions';
    protected $lastErrorId = 0;
    protected $ready = false;
    const DEV_NAME = 'e-transactions / Shopsailors';
    const DEV_WEBSITE = 'http://wiki.websailors.fr';
    const DEV_EMAIL = 'brice.parent@websailors.fr';
    protected $bank_code = 30006;
    protected $bankName = 'E-transactions - Crédit Agricole';

var colorPicker_onchangeEvents = new Array();
function colorPicker_changeColor(element,color){
    if(color == '' || color == 'default'){
        color = 'default';
        $(element + '_preview').style.backgroundColor = 'transparent';
    }else{
        if(color.substr(0,1) == '#'){
    ...
    $(element).value = color;
    eval(colorPicker_onchangeEvents[element]);
}
...
function colorPicker_button_showPopup(element,color,event){
    colorPicker_onchangeEvents[element] = event;
    window.open(

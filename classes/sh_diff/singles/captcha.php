<?php
 ...
 /*
  * This source is build on the following class :
  * ------------------------------------------------
  * Created on 4 mai 07
  *
...
$chars = 'ABDEGHKMNPRTUVWX3689';		// liste des charactère (certain caractères ne sont pas présents pour éviter les confusions)
...
$size_max = 30;					// taille maximum des caractères
...
while(++$i<$nbChar)
{
    ...
    $charList .= $char;
	$color = imagecolorallocate($_charsImgHandler,mt_rand(0,150),mt_rand(0,150),mt_rand(0,150));
...
$line = imagecolorallocate($_bgImgHandler,mt_rand(180,200),mt_rand(190,210),mt_rand(180,200));
$grill = imagecolorallocate($_bgImgHandler,mt_rand(190,210),mt_rand(180,200),mt_rand(190,210));
